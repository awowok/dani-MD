...
if (q.includes('--help')) return reply(examkosong) 
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     var hisoka = await getBuffer(picak+`User's Inventory`)
     ...
     await hisoka.send5ButImg(from, `` + '' + teksehmazeh, `Asrori Amin`, hisoka, [{"urlButton": {"displayText": "Instagram","url": `instagram.com/saya_asroriamin`}}])
  }
  break
        case 'userlimit': 
{      
...
if (q.includes('--help')) return reply(examkosong) 
 ...
 if (lokasinya === 'Jungle') {
    var image = './lib/rimba.jpg'
   } else
 if (lokasinya === 'Amazon forest') {
    var image =  './lib/amazon.jpg'
   } else
 if (lokasinya === 'Tropical forest') {
    var image = './lib/tropis.jpg'
   } else
 if (lokasinya === 'Meadow') {
    var image = './lib/padang_rumput.jpg'
   } else
 if (lokasinya === 'African forest') {
    var image = './lib/afrika.jpg'
   } else
 if (lokasinya === 'Mountains') {
   var image = './lib/pegunungan.jpg'
   }
 setTimeout( () => {
